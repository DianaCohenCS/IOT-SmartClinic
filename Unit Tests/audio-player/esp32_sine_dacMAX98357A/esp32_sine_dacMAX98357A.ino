//#include <Arduino.h> // this is for PlatformIO
#include <driver/i2s.h>
#include <math.h>

// I2S configuration
#define DAC_LRC_WS 26   //LRC on max98357a
#define DAC_DIN_SD 14   //serial data - DIN on audio device, DOUT on ESP32
#define DAC_BCLK_SCK 27  //BCLK on max98357a
...
void setup() {
  ...
  // Initialize I2S, using driver/i2s
