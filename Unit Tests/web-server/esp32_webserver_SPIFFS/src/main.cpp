/*
Based on guides:
https://www.youtube.com/watch?v=NVD46mRbVXM (using javascript)
https://randomnerdtutorials.com/esp32-web-server-spiffs-spi-flash-file-system/ (using placeholder)
*/
